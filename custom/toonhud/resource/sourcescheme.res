...
Scheme
{
	Colors
	{
		...
		"G_ActiveWindow"			"35 40 30 255" // Active window bg color
		"G_InctiveWindow"			"30 40 30 245" // Inactive window bg color
		"G_TitleBg"					"70 179 55 255" // Title bg color
		"G_TitleText"				"255 255 255 255" // Title text color
		"G_Highlight"				"71 156 51 255" // Highlight color
		"G_ConsoleBg"				"19 28 21 255" // Console bg color
		"G_ListBg"					"21 28 19 255" // List bg color
		"G_Border"					"0 0 0 26" // Border color
		"G_Text"					"199 220 201 255" // Text color
		"G_HighlightText"			"255 255 255 255" // Highlight text color
		"G_SelectedText"			"255 255 255 255" // Selected text color
		"G_DisabledText"			"203 220 199 150" // Disabled text color
		"G_ButtonBg"				"79 96 73 255" // Button bg color
		"G_ButtonText"				"203 214 200 255" // Button text color
		"G_ButtonHoverBg"			"56 156 51 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_InputBg"					"20 28 19 255" // Input bg color
	    ...
	    "QuickListBGSelected"       "71 156 51 255" // Highlight color
