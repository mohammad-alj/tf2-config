Scheme
{
	...
	Fonts
	{
		...
		"G_FontHealth"
		{
			"1"
			{
				"name"			"prototype" [$WINDOWS] // Health Font | Primary font
				"name"			"prototype" [!$WINDOWS] // Health Font | Primary font
		...
		"G_FontAmmo"
		{
			"1"
			{
				"name"			"prototype" [$WINDOWS] // Ammo Font | Primary font
				"name"			"prototype" [!$WINDOWS] // Ammo Font | Primary font
		...
		"G_FontDamage"
		{
			"1"
			{
				"name"			"prototype" [$WINDOWS] // Damage font | Primary font
				"name"			"prototype" [!$WINDOWS] // Damage font | Primary font
				"tall"			"20" // Damage size
				"weight"		"0"
				"additive"		"0"
		...
		"G_FontCritDamage"
		{
			"1"
			{
				"name"			"prototype" [$WINDOWS] // Crit damage font | Primary font
				"name"			"prototype" [!$WINDOWS] // Crit damage font | Primary font
		...
		"G_FontTargetIDHealth"
		{
			"1"
			{
				"name"			"prototype" [$WINDOWS] // Target ID health font | Primary font
				"name"			"prototype" [!$WINDOWS] // Target ID health font | Primary font
