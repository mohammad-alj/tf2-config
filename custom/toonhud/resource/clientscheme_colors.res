Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"2 222 0 255" // Highlight color
		"G_White"				"255 255 255 255"
		"G_Black"				"0 0 0 255"
		"G_Red"					"230 0 0 255"
		"G_Shadow"				"0 0 0 0" // Shadow color
		"G_LightShadow"			"0 0 0 110"
		"G_Heal"				"82 255 168 255" // Heal color
		...
		"G_LightGrey"			"234 255 0 255" // Metal color in build/destroy menu
		"G_HealthBarBg"			"0 0 0 220" // Target health bg
		"G_CurrencyBad"			"255 60 60 255" // Red currency in MvM
		"G_TransparentMenuBG"	"4 36 0 199" // Transparent menu color
		"G_PanelBg"				"0 0 0 199" // Panel color
		"G_OpaquePanelBg"		"0 0 0 255" // Opaque Panel color
		"G_Warning"				"216 8 8 255" // Warning color
		"G_HealthValue"			"114 255 120 255" // Health value color
		"G_Overheal"			"0 249 255 255" // Overhealed health value color
		"G_LowHealthValue"		"255 197 196 255" // Low health value color
		"G_AmmoClipValue"		"255 255 255 255" // Ammo in clip value color
		"G_AmmoReserveValue"	"202 255 199 255" // Ammo in reserve value color
		"G_LowAmmo"				"255 167 0 255" // Low ammo color
		"G_MetalValue"			"234 255 0 255" // Metal color
		"G_MetalIcon"			"177 178 57 255" // Metal icon color
		"G_HeadsValue"			"245 219 63 255" // Heads value color
		"G_HeadsLabel"			"249 73 5 255" // Heads value icon color
		"G_KillstreakValue"		"255 35 35 255" // Killstreak value color
		"G_KillstreakIcon"		"255 0 0 255" // Killstreak icon color
		"G_StickyColor"					"255 199 0 255" // Stickybomb color
		"G_StickyIconColor"				"124 81 0 255" // Stickybomb icon color
		...
		"G_CenteredMetalBg"			"152 108 0 148" // Centered metal background color
		"G_CenteredUberchargeBg"	 "1 255 249 145" // Centered ubercharge meter background color
		...
		"G_Footer"					"0 0 0 255" // Menu footer color
		...
		"G_KillfeedBlue"			"0 152 255 255" // Killfeed blue text
		"G_KillfeedRed"				"251 55 55 255" // Killfeed red text
		"G_KillfeedIcon"			"255 255 255 255" // Killfeed icon color
		"G_CustomHealthValue"		"120 120 120 255"
		"G_MainMenuOverlay"			"144 21 21 0" // Main Menu overlay color
		"G_MainMenuPanel"			"27 35 27 255" // Main Menu panel color
		"G_MainMenuButton"			"211 227 189 255" // Main Menu button color
		"G_MainMenuButtonHover"		"63 155 47 255" // Main Menu hovered button color
		"G_MainMenuButtonFg"		"25 38 22 255" // Main Menu button text color
		...
		"G_MenuBg"					"0 0 0 255" // Menu bg color
		"G_MenuText"				"200 200 200 255" // Menu text color
		"G_InputText"				"0 0 0 240" // Input text color
		"G_DimmInputText"			"0 0 0 100" // Dimm Input text color
		"G_DimmMenuText"			"200 200 200 120" // Dimm Menu text color
		"G_ItemDescriptionPanelBg"	"24 22 20 255" // Item description panel bg
		"G_ButtonBg"				"21 83 29 255" // Button bg color
		"G_ButtonText"				"214 206 200 255" // Button text color
		"G_ButtonHoverBg"			"19 150 1 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_ButtonSelectedBg"		"69 124 69 255" // Button selected bg color
		...
		"G_MenuShader"				"31 57 32 99" // Menu shader color
		"G_XPBar"					"0 195 14 255" // XP Bar color
		...
		"TFOrange"			"2 222 0 255" // Highlight color
	...
	BaseSettings
	{
		...
		Slider.NobColor				"2 222 0 255" // Highlight color
		Slider.TextColor			"200 200 200 255" // Menu text color
		Slider.TrackColor			"200 200 200 255" // Menu text color
		Slider.DisabledTextColor1	"200 200 200 120" // Dimm Menu text color
		Slider.DisabledTextColor2	"200 200 200 120" // Dimm Menu text color
